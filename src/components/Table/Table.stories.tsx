...
const sampleData: User[] = [
  { id: 1, name: 'John Doe', email: 'john@example.com', role: 'Admin', status: 'active', avatar: 'https://placehold.net/40x40?text=JD' },
  { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'Editor', status: 'active', avatar: 'https://placehold.net/40x40?text=JS' },
  { id: 3, name: 'Bob Johnson', email: 'bob@example.com', role: 'Viewer', status: 'inactive', avatar: 'https://placehold.net/40x40?text=BJ' },
  { id: 4, name: 'Alice Brown', email: 'alice@example.com', role: 'Editor', status: 'pending', avatar: 'https://placehold.net/40x40?text=AB' },
  { id: 5, name: 'Charlie Wilson', email: 'charlie@example.com', role: 'Admin', status: 'active', avatar: 'https://placehold.net/40x40?text=CW' },
];
